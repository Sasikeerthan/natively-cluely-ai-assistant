...
export function initializeIpcHandlers(appState: AppState): void {
  ...
  safeHandle("get-natively-usage", async () => {
    try {
      ...
      const res = await fetch(CRACKWITHAI_API_ENDPOINTS.usage, {
  ...
  safeHandle("trial:start", async () => {
    try {
      ...
      const res = await fetch(CRACKWITHAI_API_ENDPOINTS.trialStart, {
        method: 'POST',
  ...
  safeHandle("trial:status", async () => {
    try {
      ...
      const res = await fetch(CRACKWITHAI_API_ENDPOINTS.trialStatus, {
  ...
  safeHandle("trial:convert", async (_, choice: string) => {
    try {
      ...
      await fetch(CRACKWITHAI_API_ENDPOINTS.trialConvert, {
        method: 'POST',
  ...
  safeHandle("trial:end-byok", async () => {
    try {
      ...
      const token = cm.getTrialToken();
      if (token) {
        fetch(CRACKWITHAI_API_ENDPOINTS.trialConvert, {
          method: 'POST',
          headers: { 'Content-Type': 'application/json', 'x-trial-token': token },
